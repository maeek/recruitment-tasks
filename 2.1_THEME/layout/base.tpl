  ...
  <div class="container shb-footer-background">
    <div class="columns">
      ...
      <div class="column is-offset-1-desktop is-6-tablet is-3-desktop">
        <h2 class="shb-footer-menu-label">{trans}store_theme_translations.footer_menu_1_title{/trans}</h2>
      ...
      {/if}
      {if $settings->show_ft_menu_2 && $settings->ft_menu_2 != ""}
      <div class="column is-6-tablet is-3-desktop {if !$settings->show_ft_menu_1}is-offset-1-desktop{/if}">
        <h2 class="shb-footer-menu-label">{trans}store_theme_translations.footer_menu_2_title{/trans}</h2>
        <ul class="shb-footer-nav">
          {foreach from=$menulists->{$settings->ft_menu_2}->links item="menu"}
          <li><a href="{$menu->url}">{$menu->title}</a></li>
          {/foreach}
        </ul>
      </div>
      {/if}
      <div class="column is-12-tablet {if (!$settings->show_ft_menu_2 && $settings->show_ft_menu_1) || (!$settings->show_ft_menu_1 && $settings->show_ft_menu_2)}is-7-desktop{else if !$settings->show_ft_menu_1&& !$settings->show_ft_menu_2}is-11-desktop{else}is-4-desktop{/if}">
        {if $settings->footer_show_social}
        <h2 class="shb-footer-menu-label align-right-desktop">{trans}store_theme_translations.social_title{/trans}</h2>
...
{"banner_1.js"|asset_url:script_tag}
